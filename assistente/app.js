(() => {
  ...
  function classify(raw){
    ...
    if(hasAny(t,["onde fica","endereco","endereço","loja fisica","loja física","curitiba","bairro alto","empresa confiavel","empresa confiável","sao confiaveis","e confiavel","golpe","seguranca","segurança","avaliacoes google","avaliações google"])) return "location_trust";
