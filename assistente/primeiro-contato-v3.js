(() => {
  ...
  function isGeneralOfferQuestion(cleaned){
    const exact = [
      "o que voces vendem", "o que voce vende", "o que vcs vendem", "o que vendem", "o que vende",
      "voces vendem o que", "voce vende o que", "vcs vendem o que", "vendem o que", "vende o que",
      "voces vendem oq", "voce vende oq", "vcs vendem oq", "vendem oq", "vende oq",
      "voces vendem o q", "voce vende o q", "vcs vendem o q", "vendem o q", "vende o q",
      "o que voces oferecem", "voces oferecem o que", "o que voces tem", "voces tem o que",
      "o que tem aqui", "o que voces fazem", "o que voce faz", "com o que voces trabalham",
      "voces trabalham com o que", "voce trabalha com o que", "vcs trabalham com o que", "trabalham com o que",
    ...
    const endsWithWhat = /(?:^|\s)(o que|o q|oq)(?: mesmo)?$/.test(cleaned);
    const hasBusinessVerb = /\b(vendem|vende|trabalham|trabalha|fazem|faz|tem|oferecem|oferece)\b/.test(cleaned);
    if(endsWithWhat && hasBusinessVerb && cleaned.length <= 80) return true;

    if(/^(com que|com quais|que|quais) (tipo|tipos)? ?(de )?(peca|pecas|produto|produtos|joia|joias) (voces )?(trabalham|vendem|fazem|tem)$/.test(cleaned)) return true;

    return includesAny(cleaned, [
      "queria saber o que voces vendem", "gostaria de saber o que voces vendem",
      "queria saber voces vendem o que", "gostaria de saber voces vendem o que",
  ...
  function classify(text){
    ...
    if(isGeneralOfferQuestion(cleaned)) return "intro";
    return null;
  }
  ...
  window.__primeiroContatoV3 = {normalize, classify, isGeneralOfferQuestion, replies, mainOptions, jewelryOptions};
})();